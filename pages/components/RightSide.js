...
const RightSide = ({ scrolled }) => {
    return(
        <div className="flex">
            <div className={scrolled ? 'lg:mx-[15%] mt-10 mx-auto lg:mt-20 lg:h-[580px] w-[350px] border border-gray-500 lg:px-10 px-8 py-10 ':'lg:mx-[25%]  mt-20 lg:h-[600px] lg:w-[400px] w-[350px] border border-gray-500 lg:px-10 px-8 py-10 mx-auto'}>
