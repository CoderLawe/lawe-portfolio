const Contact = () => {
    return(
        <div className="py-24 lg:mx-20 mx-12 block">
            ...
            <p className="text-gray-400 text-[30px]">-Lawe</p>
            ...
            <form className="flex justify-center mt-8">
                <div className="flex-col space-y-5">
                    ...
                    <div className="flex justify-center">
                        <button className="border border-headerYellow text-gray-400 font-serif py-6 px-20 active:scale-90 hover:border-gray-400" >SUBMIT</button>
