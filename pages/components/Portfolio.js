    ...
    return(
        <div id="portfolio" className="lg:mx-12 mx-8 pb-10 mt-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-16">
                ...
                <Card link="https://covid-19-tracker-lawe.web.app/" title="Covid-19 Tracker" img="https://lawe-portfolio.web.app/img/covid-tracker-large.png"  description="This is an Awesome COVID-19 tracker, built with React,that pulls data from an API. It was built in conjunction with the guys over at Clever programmer, Naz Dumansky and Sonny Sangha. It has insightful information, a live map showing cases per country, and graphs, that show live data as well. I definitely learned a lot through this build"/>
                <Card link="https://react-hulu-clone-85e94.web.app/"title="Expenses Tracker ReactJS" img="https://cdn.discordapp.com/attachments/817048198022430761/883023421137633330/Screen_Shot_2021-09-02_at_6.18.07_PM.png" description="This is a really cool expenses tracker that I recently built as a practice project. It makes use of ReactJS, react context API, firebase Firestore, firebase realtime-database, tailwind css, and finally firebase authentication" />
                <Card link=" https://bites-on-the-double.vercel.app/" title="Restaurant App with API and admin CMS" img="https://cdn.discordapp.com/attachments/817048198022430761/912216484963549234/Screen_Shot_2021-11-22_at_7.30.40_AM.png" description="I built this Restaurant app with NextJS TailwindCSS, and JSON server for the backend CMS. I was mostly experimenting with several animation libraries, and ways of making a CMS."/>
                <Card link="https://airbnb-lawe.vercel.app/" title="Airbnb Clone NextJS TailwindCSS" img="https://cdn.discordapp.com/attachments/817048198022430761/882950927550672917/bnb.JPG" description="This is an Awesome airbnb clone built with NextJS and TailwindCss. It implements some search functionality, vercel hosting, a mock detail page replica, and a working date picker. This was quite an enjoyable build"/>
                <Card link="https://lawe.pythonanywhere.com"title="Ecommerce WebApp with Python and Django" img="https://lawe-portfolio.web.app/img/ecom_cover.png" description="This was definitely one of my most complicated builds to date. It features a neat UI, Paypal payment integration, a blog, the ability to add reviews, a fully built Admin console/CRM, and loads of other features. This is without doubt the project that has taught me the most about django"/>
                <Card link="https://amazon-clone-psi-nine.vercel.app"title="Amazon CLone with NextJS TailwindCSS and FakestoreAPI" img="https://cdn.discordapp.com/attachments/817048198022430761/863165976153292861/Screen_Shot_2021-07-09_at_11.12.49_PM.png" description="This is an Amazon clone built with React and NextJS, as well as Redux for state management, NextAuth and Firebase for Authentication, and Firestore"/>
